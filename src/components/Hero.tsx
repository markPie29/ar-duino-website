      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-8 items-center">
          ...
          >
            ...
            {/* Logo + Brand Heading */}
            <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-4 sm:gap-5 mb-6 text-center sm:text-left">
              <div className="relative group shrink-0">
                ...
                <div className="relative w-20 h-20 sm:w-22 sm:h-22 rounded-2xl bg-[#162133] p-3 border border-white/20 flex items-center justify-center shadow-2xl">
                  <img
                    src="/Logo Main.png"
                    alt="AR-DUINO Logo"
              ...
              <div>
                <h1 className="font-nunito text-4xl sm:text-5xl lg:text-6xl xl:text-7xl font-extrabold text-white tracking-tight leading-none">
                  AR-DUINO
                </h1>
                <p className="text-[#35A2F4] font-nunito font-bold text-base sm:text-lg lg:text-xl mt-1">
            ...
            {/* Full Tagline */}
            <p className="font-inter text-base sm:text-lg lg:text-xl text-[#8A9BB5] max-w-xl lg:max-w-2xl leading-relaxed mb-8">
            ...
            <div className="flex flex-col sm:flex-row items-center gap-4 w-full sm:w-auto mb-8">
              <button
                ...
                className="w-full sm:w-auto h-14 inline-flex items-center justify-center gap-3 px-8 rounded-2xl bg-gradient-to-r from-[#FC904F] to-[#FC904F]/90 text-white font-nunito font-extrabold text-base sm:text-lg shadow-xl shadow-[#FC904F]/30 hover:shadow-[#FC904F]/50 hover:scale-[1.02] active:scale-[0.98] transition-all cursor-pointer group"
              >
              ...
              <button
                ...
                className="w-full sm:w-auto h-14 inline-flex items-center justify-center gap-2.5 px-7 rounded-2xl bg-[#1c2b3f]/80 border border-white/10 hover:border-[#9B5FF5]/40 text-white font-nunito font-bold text-base hover:bg-[#1c2b3f] transition-all cursor-pointer group backdrop-blur-md"
              >
            ...
            {/* Platform indicators */}
            <div className="flex flex-wrap items-center justify-center lg:justify-start gap-6 text-xs text-[#8A9BB5]">
          ...
          {/* Right Column: Single Interactive Smartphone Mockup */}
          <motion.div
            initial={{ opacity: 0, scale: 0.95 }}
            animate={{ opacity: 1, scale: 1 }}
            transition={{ duration: 0.8, delay: 0.2, ease: 'easeOut' }}
            className="lg:col-span-6 flex justify-center w-full mt-6 lg:mt-0"
          >
            <HeroMockupCardDeck />
          </motion.div>
